                ...
                return (
                  <div className="flex flex-col gap-5 fade-up">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                      <div
                        className="rounded-lg border p-4 flex flex-col justify-between transition-all duration-300 card-hover relative overflow-hidden"
                        style={{
                          background: "var(--surface)",
                          borderColor: "var(--border)",
                        }}
                      ...
                      >
                        ...
                        <div>
                          <div
                            className="text-xl font-bold font-mono tracking-tight truncate animate-pulse"
                            style={{ color: "var(--text-primary)" }}
                          >
                            Rs.{" "}
